...
### 💻 Description
This project is designed to perform end-to-end (E2E) tests for the [Buggy Cars](https://buggy.justtestit.org/). It automates testing across both desktop and mobile browsers to ensure a high-quality user experience. The tests are executed weekly as part of a continuous integration (CI) pipeline to detect issues early.
...
1. Run tests on CI (Needs permisions): https://github.com/marbhg/e2e-cypress-buggycars
